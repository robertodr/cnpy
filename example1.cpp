...
int main()
{
    ...
    cnpy::npy_save("arr1.npy",&data.front(),shape,"w");
    /* Allowed in C++11 */
    ...
    cnpy::npy_save("arr1.npy",&data.front(),shape,"a");

    //now write to an npz file
    //non-array variables are treated as 1D arrays with 1 element
    double myVar1 = 1.2;
    char myVar2 = 'a';
    cnpy::npz_save("out.npz","myVar1",myVar1,"w"); //"w" overwrites any existing file
    cnpy::npz_save("out.npz","myVar2",myVar2,"a"); //"a" appends to the file we created above
    cnpy::npz_save("out.npz","arr1",&data.front(),shape,"a"); //"a" appends to the file we created above
